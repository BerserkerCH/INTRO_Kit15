...
/* ----------------------------------------------------------------------------
  ...
  #error CMP PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MK11DA5) /* CMP0, CMP1 */ && \
      !defined(MCU_MK11DA5WS) /* CMP0, CMP1 */ && \
      ...
      !defined(MCU_MK21DA5) /* CMP0, CMP1 */ && \
      !defined(MCU_MK21DA5WS) /* CMP0, CMP1 */ && \
      !defined(MCU_MK21D5) /* CMP0, CMP1 */ && \
      !defined(MCU_MK21D5WS) /* CMP0, CMP1 */ && \
      !defined(MCU_MK21FA12) /* CMP0, CMP1, CMP2 */ && \
      !defined(MCU_MK21FA12WS) /* CMP0, CMP1, CMP2 */ && \
