...
#define PL_CONFIG_HAS_BEEP_TASK			(1 && !defined(PL_LCOAL_CONFIG_HAS_BEEPSYTASK_DISABLED) && PL_CONFIG_BOARD_IS_ROBO)
#define PL_CONFIG_HAS_TACHO_TASK		(1 && !defined(PL_LOCAL_CONFIG_HAS_TACHO_TASK_DISABLED) && PL_CONFIG_BOARD_IS_ROBO)
#define PL_CONFIG_HAS_EVENT_TASK		(1 && !defined(PL_LOCAL_CONFIG_HAS_EVENT_TASK_DISABLED))
/*!
